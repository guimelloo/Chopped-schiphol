...
<template>
    <Head :title="`Boeking ${boeking.boekings_nummer}`" />

    <!-- Print CSS: verberg navigatie bij printen -->
    <style>
        @media print {
    ...
    <SchipholLayout>
        <div class="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
            <!-- Actieknop en terug (niet printen) -->
            ...
            <div class="geen-print mb-6 flex items-center gap-3 rounded-xl bg-green-50 border border-green-200 p-4">
                ...
                <div>
                    <p class="font-bold text-green-800">Boeking bevestigd!</p>
                    <p class="text-sm text-green-700">Een bevestiging is verzonden naar {{ boeking.email_reiziger }}</p>
                </div>
            </div>

            <!-- Boekingskaart (ook geprint) -->
            <div class="print-kaart overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                ...
                <div class="bg-blue-900 p-6 text-white">
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <p class="text-blue-200 text-sm">Boekingsbevestiging</p>
                        </div>
                        <div class="text-right">
                            <p class="text-xs text-blue-300">Boekingsnummer</p>
                            <p class="text-2xl font-bold tracking-widest">{{ boeking.boekings_nummer }}</p>
                            <span :class="['mt-1 inline-block rounded-full px-3 py-0.5 text-xs font-bold uppercase', statusKleur[boeking.status] || 'bg-gray-100 text-gray-800']">
                                {{ boeking.status }}
                            </span>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        <!-- Reiziger -->
                        <div>
                            <h3 class="mb-2 text-xs font-bold uppercase tracking-wider text-gray-400">Reiziger</h3>
                        ...
                        <!-- Vluchtdetails -->
                        <div>
                            <h3 class="mb-2 text-xs font-bold uppercase tracking-wider text-gray-400">Vluchtdetails</h3>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs text-gray-400">Geboekt op</p>
                            <p class="text-sm text-gray-600">{{ boeking.aangemaakt_op }}</p>
                        </div>
                        <div class="text-right">
                            <p class="text-xs text-gray-400">Totaalprijs</p>
